            ...
            <div className="container">
                ...
                lg:grid-cols-4 gap-8">
                  ...
                  <div className="col-span-2 py-10 pl-5 bg-gradient-to-br
                    from-gray-400/90 to-gray-100 text-white 
                    rounded-3xl relative h-[320px] flex items-end">
                        <div className="">
                            <div className="space-y-2 mb-4">
                                ...
                                font-bold opacity-40 mb-2">Gaming</p>
                                <Button
                                text="Browse"
                                bgColor={"bg-primary"}
                        ...
                        <img 
                        src={Image1} alt=""
                        className="w-[250px] absolute top-1/2
                        -translate-y-1/2 -right-0 "
                        />
                    </div>
                    {/* secondary col */}
                    <div className="py-10 pl-5 bg-gradient-to-br
                    from-brandGreen/90 to-brandGreen/90 text-white 
                    rounded-3xl relative h-[320px] flex items-start">
                        <div>
                            <div className="mb-4">
                                <p className="mb-[2px] 
                                text-gray-400">Enjoy</p>
                                <p className="text-2xl font-semibold
                                mb-[2px]">With</p>
                                <p className="text-4xl xl:text-5xl 
                                font-bold opacity-40 mb-2">Vr</p>
                                <Button
                                text="Browse"
                                bgColor={"bg-white"}
                    ...
                    {/* third col */}
                    <div className="py-10 pl-5 bg-gradient-to-br
                    from-brandBlue to-brandBlue/90 text-white 
                    rounded-3xl relative h-[320px] flex items-start">
                        <div>
                            <div className="mb-4">
                                <p className="mb-[2px] 
                                ...
                                mb-[2px]">With</p>
                                <p className="text-4xl xl:text-5xl 
                                font-bold opacity-40 mb-2">Speaker</p>
                                <Button
                                text="Browse"
                                bgColor={"bg-white"}
